...

{
    ...
    public class UltimusSpear : ModProjectile
...

        {
...

            {
...

                {
                    ...
                    if (player.itemAnimation < player.itemAnimationMax / 2) Projectile.NewProjectile(projectile.Center.X + projectile.velocity.X, projectile.Center.Y + projectile.velocity.Y, projectile.velocity.X * 2f, projectile.velocity.Y * 1.5f, mod.ProjectileType("Ultimuspro"), projectile.damage, projectile.knockBack * 0.85f, projectile.owner, 0f, 0f);
